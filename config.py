...
available_setting = {
    # openai api配置
    "open_ai_api_key": "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",  # openai api key
    ...
    "group_name_white_list": ["董事会"],  # 开启自动回复的群名称列表
    "group_name_keyword_white_list": [],  # 开启自动回复的群名称关键词列表
    "group_chat_in_one_session": ["董事会"],  # 支持会话上下文共享的群名称
